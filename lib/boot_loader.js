...
class BootLoader extends Loader {
  constructor(patterns, opts) {
    ...
    if (opts.plugin) { this[PROPERTY_PLUGIN_MODULE_LOADER] = new PluginModuleLoader(patterns, profiles); }
  }
...
function loadProfiles(patterns, opts, childOpts, completed = {}) {
  ...
  if (!profileOpts.package && !profileOpts.cwd) { return [{ ...opts, cwd, patterns: _patterns }]; }
